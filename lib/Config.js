...
( function() {
    ...
    Config.prototype.trace = function( key ){
        ...
        var normalizedKey = (key.charAt(0) !== '.' ) ? "." + key : key;
        return this._trace[ normalizedKey ];
    };
    ...
    Config.prototype.set = function( keyPath, value, traceSource ){
        ...
        if( keyPath === '.' ){
            ...
            this._data[ keyPath ] = this._merge( this._data[ keyPath ], value, this._trace, traceSource, keyPath );
        }
    };
    ...
    Config.prototype._merge = function( backObject, frontObject, sourceName, currentPath ){
        ...
        this._trace[ currentPath ] = sourceName;
    ...
    // ----------------------------
    Config.prototype._setValueForDottedKeyPath = function( targetData, configValue, configKeyPathComponents ){
        if( configKeyPathComponents.length === 1){
            targetData[ configKeyPathComponents ] = this._merge( targetData[ configKeyPathComponents ], configValue );
        } else {
            ...
            this._setValueForDottedKeyPath( targetData[nextComponent], configValue, configKeyPathComponents );
        }
    }
